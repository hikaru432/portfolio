...
const Button = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-xs transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2';
...
Button.propTypes = {
  ...
  href: PropTypes.string // Add prop type for href
};
